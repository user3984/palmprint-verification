...
from backend.modules import ConvModule, InvertedResidual, TransformerEncoderLayer
...
class MobileViT(nn.Module):
    """MobileViT backbone.
    Codes are modified from https://github.com/open-mmlab/mmpretrain
    ...
    Args:
        ...
        last_channels (int): Channels of last layer.
            Defaults to 1024.
        ...
        act_cfg (dict, optional): Config dict for activation layer.
            Defaults to dict(type='SiLU').
        gd_conv (bool, optional): Whether to apply global depthwise
            convolution to the last layer. Defaults to False.
    """  # noqa
    ...
    def __init__(self,
        ...
        self.pool = nn.Conv2d(in_channels=last_channels,
                              out_channels=last_channels,
                              kernel_size=8,
                              groups=last_channels) if gd_conv else nn.AdaptiveAvgPool2d((1, 1))
